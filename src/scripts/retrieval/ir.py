...
if __name__ == "__main__":
    ...
    parser.add_argument('--compat', help='reproduce competition entry', action='store_true')
    ...
    method = TopNDocsTopNSents(db, args.max_page, args.max_sent, args.whole_docs, args.compat, args.model)
